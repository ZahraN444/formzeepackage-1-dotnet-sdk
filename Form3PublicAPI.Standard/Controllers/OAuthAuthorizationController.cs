...
namespace Form3PublicAPI.Standard.Controllers
{
    ...
    public class OAuthAuthorizationController : BaseController
    {
        ...
        public Models.OAuthToken RequestTokenOAuth2(
                string authorization,
                string scope = null,
                Dictionary<string, object> fieldParameters = null)
            => CoreHelper.RunTask(RequestTokenOAuth2Async(authorization, scope, fieldParameters));
        ...
        /// <returns>Returns the Models.OAuthToken response from the API call.</returns>
        public async Task<Models.OAuthToken> RequestTokenOAuth2Async(
                string authorization,
                string scope = null,
                Dictionary<string, object> fieldParameters = null,

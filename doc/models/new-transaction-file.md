...
|  --- | --- | --- | --- |
| `Attributes` | [`Attributes52`](../../doc/models/attributes-52.md) | Required | - |
| `CreatedOn` | `DateTime?` | Optional | - |
| `Id` | `Guid` | Required | - |
| `ModifiedOn` | `DateTime?` | Optional | - |
| `OrganisationId` | `Guid` | Required | Unique ID of the organisation this resource is created by |
| `Relationships` | [`TransactionFileRelationships`](../../doc/models/transaction-file-relationships.md) | Optional | - |
| `Type` | [`Type5Enum?`](../../doc/models/type-5-enum.md) | Optional | - |
...
```json
{
  ...
  "id": "00000256-0000-0000-0000-000000000000",

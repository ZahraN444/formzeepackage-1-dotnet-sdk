...
|  --- | --- | --- | --- |
| `Attributes` | [`Attributes30`](../../doc/models/attributes-30.md) | Optional | - |
| `CreatedOn` | `DateTime?` | Optional | - |
| `Id` | `Guid` | Required | Unique resource ID |
| `ModifiedOn` | `DateTime?` | Optional | - |
| `OrganisationId` | `Guid` | Required | - |
| `Relationships` | [`Relationships8`](../../doc/models/relationships-8.md) | Optional | - |
...
```json
{
  ...
  "organisation_id": "0000024a-0000-0000-0000-000000000000",
  "type": "direct_debit_recall_submissions",
  "version": 0,
  "attributes": {

...
|  --- | --- | --- | --- |
| `Attributes` | [`Attributes40`](../../doc/models/attributes-40.md) | Optional | - |
| `CreatedOn` | `DateTime?` | Optional | - |
| `Id` | `Guid` | Required | - |
| `ModifiedOn` | `DateTime?` | Optional | - |
| `OrganisationId` | `Guid` | Required | Unique ID of the organisation this resource is created by |
| `Relationships` | [`SchemeFileAdmissionRelationships`](../../doc/models/scheme-file-admission-relationships.md) | Optional | - |

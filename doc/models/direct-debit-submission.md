...
|  --- | --- | --- | --- |
| `Attributes` | [`Attributes38`](../../doc/models/attributes-38.md) | Optional | - |
...
| `Relationships` | [`DirectDebitSubmissionRelationships`](../../doc/models/direct-debit-submission-relationships.md) | Optional | - |
| `Type` | `string` | Optional | Name of the resource type<br>**Constraints**: *Pattern*: `^[A-Za-z_]*$` |
| `Version` | `int?` | Optional | Version of the resource<br>**Constraints**: `>= 0` |

## Example (as JSON)

```json
{
  "id": "ee2fb143-6dfe-4787-b183-ca8ddd4164d2",

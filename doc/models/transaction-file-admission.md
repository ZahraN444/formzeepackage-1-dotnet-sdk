...
|  --- | --- | --- | --- |
| `Attributes` | [`Attributes43`](../../doc/models/attributes-43.md) | Optional | - |
| `CreatedOn` | `DateTime?` | Optional | - |
| `Id` | `Guid` | Required | - |
| `ModifiedOn` | `DateTime?` | Optional | - |
| `OrganisationId` | `Guid` | Required | Unique ID of the organisation this resource is created by |
| `Relationships` | [`TransactionFileAdmissionRelationships`](../../doc/models/transaction-file-admission-relationships.md) | Optional | - |
| `Type` | [`Type3Enum?`](../../doc/models/type-3-enum.md) | Optional | - |
...
```json
{
  ...
  "id": "00001ae2-0000-0000-0000-000000000000",

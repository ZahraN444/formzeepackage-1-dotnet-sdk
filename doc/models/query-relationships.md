...
| `QueryAdmission` | [`RelationshipsQueryAdmission`](../../doc/models/relationships-query-admission.md) | Optional | - |
| `QueryResponse` | [`RelationshipsFullQueryResponse`](../../doc/models/relationships-full-query-response.md) | Optional | - |
| `QuerySubmission` | [`RelationshipsQuerySubmission`](../../doc/models/relationships-query-submission.md) | Optional | - |
